...
<div class="testing-user-view">
    ...
    <div class="card testing-card">
        ...
        <ul class="list-group list-group-flushtesting-card">
            <li class="list-group-item testing-card">Дата прохождения: <?= Html::encode(Yii::$app->formatter->asDate( $model->date, 'd-m-Y H:i:s')) ?></li>
